...
({ title, content }) => {
    ...
    return(
        <div ref={wrapperRef} className={styles.questions}>
            <Button className={styles.faqButton} fullWidth color='light' size='medium'>
                {<div><Icon className={styles.icon} name={iconSelect}/><b>{title}</b></div>}
            </Button>

            {show ? (
                <div  className={
                    show ? styles.answersActive : styles.answer
                  }>
