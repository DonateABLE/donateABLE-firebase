...
const CharityBox: FunctionComponent<Props> = ({
    className,
    charity,
    charityTypes,
}) => (
    <div className={classNames(styles.charity, className)}>
        ...
        <div className={styles.type}>
            <Popup
                openButton={
                    <Icon name={charity.type?.icon ?? "question-circle"} />
                }
            >
                {charityTypes.map((t) => (
        ...
        <div className={styles.currentlyDonating}>
            Currently Donating: <b>{charity.currentlyDonating}</b>
        </div>
        <div className={styles.donatorsToDate}>
            Donators to Date: <b>{charity.donatorsToDate}</b>
        </div>
