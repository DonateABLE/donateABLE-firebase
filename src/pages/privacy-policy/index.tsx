...
const PrivacyPolicy: FunctionComponent = () => {
    return <Fragment>
        ...
        <div className={styles.PrivacyPolicy}>
            ...
            website, except where stated otherwise. It will notify you of
            the following:
            <ul>
            ...
            future to tell you about statistics, new charities or features,
            ...
            job (e.g. billing or customer service) are granted access to
            personally identifiable information. The computers/servers on
            ...
            target the interests of our users to enhance their experience on
            our site. Usage of a cookie is in no way linked to any
            personally identifiable information on our site. Some of our
            business partners may use cookies on our site (e.g.,
            advertisers). However, we have no access to or control over
            these cookies.
            <br />
            <br />
            <strong>Links</strong>
            ...
            <strong>
                ...
                you should contact us immediately via email at
